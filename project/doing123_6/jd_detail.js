...
window.onload=function(){
	...
	$(".app_jd").mouseout(hideItems);
	$(".service").mouseover(showItems);
	$(".service").mouseout(hideItems);
	$("#category").mouseover(showSub1);
	$("#category").mouseout(hideSub1);
	$("#cate_box").mouseover(showSub2);
	$("#cate_box").mouseout(hideSub2);
	//为id为product_detail下的class为main_tabs的ul绑定单击事件为change
	$("#product_detail>ul.main_tabs").click(change);
	$("#comment_list>ul.main_tabs").click(change);
	$("#discuss>ul.main_tabs").click(change);
	$("#consult>ul.main_tabs").click(change);
	/*zoom.init();*/
	$("#store_select").mouseover(function(){
		$("#store_content").style.display="block";
		$("#store_select>h3").className="hover";
	});
	$("#store_select").mouseout(function(){
		$("#store_content").style.display="none";
		$("#store_select>h3").className="";
	});
	$("#store_tabs").mouseover(change1);
	$("#choose_color>div.content").click(change2);
	$("#choose_amount>div.content").click(num);
}
//---------------------全部商品分类菜单---------------------------------
function showSub1(){
...
/*var zoom={
	...
	init:function(){
		...
		$("#preview>h1").click(this.move.bind(this));
		$("#icon_list").mouseover(this.changeMImg);
		...
		$("#superMask").mousemove(this.maskMove.bind(this))
	},
	move:function(e){
		var target=e.target;
